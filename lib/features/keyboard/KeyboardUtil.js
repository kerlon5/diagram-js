...
const KEYS_SELECTALL = ['a', 'A', 'KeyA'];
const KEYS_COPY = ['c', 'C', 'KeyC'];
const KEYS_PASTE = ['v', 'V', 'KeyV'];
const KEYS_CUT = ['x', 'X', 'KeyX'];
const KEYS_REDO = ['y', 'Y', 'KeyY'];
const KEYS_UNDO = ['z', 'Z', 'KeyZ'];
...
export function isSelectAll(event) {
  return isCmd(event) && isKey(KEYS_SELECTALL, event);
}
